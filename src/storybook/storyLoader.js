...
function loadStories() {
  require('../components/Button/index.story');
  ...
  require('../screens/main/index.story');
...
const stories = [
  '../components/Button/index.story',
  '../components/Calendar/index.story',
